		...
		>
			...
			<div class="w-auto py-8 pr-4 sm:w-1/2 lg:w-2/3 lg:pl-16 lg:pr-60">
				...
				<p class="max-w-3xl py-5 text-lg leading-7" data-scroll data-scroll-speed="1.2">
					...
					<br /><br />Mit dem IBC HomeOne Hub als Herzstück vernetzt sich Ihre Anlage intelligent
					und optimiert automatisch die Energieflüsse. So nutzen Sie Ihren Solarstrom optimal - ganz
