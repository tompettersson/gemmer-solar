...
<section>
	...
	>
		...
		<div class="w-auto pl-7 md:w-1/2 md:pl-12" data-scroll-section>
			<h2
				class="max-w-lg pb-6 pr-12 pt-12 text-3xl font-extrabold leading-tight text-white md:pt-2 lg:text-[45px]"
				data-scroll
		...
		>
			<img
				src="./img/4012.png"
				class="absolute bottom-[40px] left-[-10%] z-20 hidden max-h-48 lg:block"
				alt=""
				data-scroll
				data-scroll-speed="2"
			/>
