	...
	>
		<div class="w-auto py-5 md:w-[48%]">
			<div class="rounded-md bg-white p-10" id="learnmore">
				...
				<h3 class="pb-2 text-3xl font-bold text-zinc-900 lg:text-3xl">
					Professionelle Installation & Service
				</h3>
				<p class="py-3 text-lg leading-7">
					Als erfahrener Installationspartner sorgen wir für die fachgerechte Montage Ihrer IBC
